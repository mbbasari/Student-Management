...
public class ErrorMessages {
    ...
    public static final String NOT_FOUND_USER_WITH_USER_ROLE_MESSAGE = "Error: The role information of the user with id %s is not user-role: %s";
    public static final String NOT_FOUND_ADVISOR_MESSAGE = "Error: The Advisor Teacher with id %s not found";
